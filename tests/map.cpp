...
static void		key_comp(bool show_errors)
{
	...
	char lowest1 = map1.begin()->first;

	out1 << "lowest: [" << lowest1 << "]" << std::endl;
	...
	char lowest2 = map2.begin()->first;

	out2 << "lowest: [" << lowest2 << "]" << std::endl;
